  ...
  return (
    <div className="cart-product">
        ...
        <div className="cart-product__texts">
          ...
          {product.capacity && (
            <p className="cart-product__text">
              {capacityOptions.find(({value}) => value === product.capacity).title}
            </p>
          )}
      ...
      <div className="cart-product__right">
        <Counter count={product.qty} onDecrease={handleDecrease} onIncrease={handleIncrease}/>
        <p className="cart-product__price">{product.price*product.qty} so'm</p>
      </div>
    </div>
  );
}
